...
document.getElementById('iscrizione-form').addEventListener('submit', async function(e){
  ...
  try {
    ...
    // Formspree requires an email field
    formData.append('email', partecipanti[0].email || 'info@imbcacademy.it');

    // Submit to Formspree
    const response = await fetch('https://formspree.io/f/xzdvygoo', {
      method: 'POST',
